...
class RecordController extends GetxController {
  var records = <RecordModelData>[].obs;
  late Box<SalesRecordModel> salesBox;
  ...
  Future<void> init() async {
    salesBox = await Hive.openBox<SalesRecordModel>('salesRecords');
  }
  ...
  Future<void> addOrUpdateSales(DateTime date, List<RecordModel> sales) async {
    ...
    SalesRecordModel? existingRecord = salesBox.get(salesDateKey);
    ...
    if (existingRecord != null) {
      ...
      await salesBox.put(salesDateKey, existingRecord);
    } else {
  ...
  SalesRecordModel? getSalesByDate(DateTime date) {
    return salesBox.get(_formatDateKey(date));
  }
